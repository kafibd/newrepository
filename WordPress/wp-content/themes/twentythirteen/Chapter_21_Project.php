<?php
/*
 	Template name:Chapter_21_Project
 */
?>
<?php 
	function Chapter_21_Project_css(){
?>
		<link rel="stylesheet" href="<?php bloginfo("template_url")?>/Chapter_21_Project.css" type="text/css">
<?php 
	}
	add_filter('wp_head', 'Chapter_21_Project_css');
?>
<?php get_header();?>
<div class="parent-img">
	<img src="<?php bloginfo("template_url")?>/images/sony.jpg" widht="200px" height="100px" >
</div>
