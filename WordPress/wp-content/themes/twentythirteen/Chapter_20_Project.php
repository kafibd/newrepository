<?php
/*
 	Template name:Chapter_20_Project
 */
?>
<?php 
	function Chapter_20_Project_css(){
?>
		<link rel="stylesheet" href="<?php bloginfo("template_url")?>/Chapter_20_Project.css" type="text/css">
<?php 
	}
	add_filter('wp_head', 'Chapter_20_Project_css');
?>
<?php get_header();?>
